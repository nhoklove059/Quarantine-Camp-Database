				...
				<div class="form-head d-flex mb-sm-4 mb-3">
					...
					<div>
						<a href="javascript:void(0)" class="btn btn-primary mr-3" data-toggle="modal"
							data-target="#addOrderModal">+New Doctor</a>
							...
							<div class="modal-body">
								<form action="add_doctor.php" method="GET">
									<div class="form-group">
										...
										<input type="first_name" class="form-control" name="fname"
											placeholder="First name"><br>
										<input type="last_name" class="form-control" name="lname"
					...
					<div class="col-12">
						<div class="table-responsive card-table">
							<table id="example5" class="display dataTablesCard table-responsive-xl">
								...
								<tbody>
									<?php
									$sql = "SELECT * FROM  `people` WHERE peopleID != 'NULL'";
