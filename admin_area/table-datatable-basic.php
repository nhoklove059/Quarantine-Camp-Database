            ...
            <div class="container-fluid">
                <div class="form-head align-items-center d-flex mb-sm-4 mb-3">
                    ...
                    <div>
                        ...
                        <a href="admin_area/table-datatable-basic.php?status=all" class="btn btn-outline-primary"><i class="las la-calendar-plus scale5 mr-3"></i>All</a>
                        <a href="admin_area/table-datatable-basic.php?status=being_treatment" class="btn btn-outline-primary"><i class="las la-calendar-plus scale5 mr-3"></i>Being treatment</a>
                        <a href="admin_area/table-datatable-basic.php?status=recovered" class="btn btn-outline-primary"><i class="las la-calendar-plus scale5 mr-3"></i>Recovered</a>
                    </div>
                </div>
                <!-- Add Order -->
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                    <tr>
                                                        ...
                                                        <td><a href="javascript:void(0);"><strong>
                                                                    <?php
                                                                    $sql_patient_symptom = "SELECT * FROM `patient_symptom`WHERE patient_id =" . $row["patient_id"];
                                                                    ...
                                                                    if (mysqli_num_rows($result_patient_symptom) > 0) {
                                                                        ...
                                                                        while ($row_patient_symptom = mysqli_fetch_assoc($result_patient_symptom)) {
                                                                            echo $row_patient_symptom["symptom"] . "<br>";
                                                                        }
                                                                    } else {
                                                                        echo "Unrecord";
                                                                    }
                                ...
                                <td>
                                    ...
                                    ?>
                                                <a href="admin_area/add_care.php?patient_id=<?php echo $row['patient_id'];
