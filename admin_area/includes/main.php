                            ...
                            <li class="nav-item dropdown header-profile">
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    <a href="./app-profile.php" class="dropdown-item ai-icon">
                                        ...
                                        <span class="ml-2"><?php
										switch ($_SESSION["admin_job"]) {
											case 'Doctor':
												echo "#D-".$_SESSION['admin_id']." ".$_SESSION['admin_email']; 
												break;
												case 'Nurse':
													echo "#N-".$_SESSION['admin_id']." ".$_SESSION['admin_email']; 
													break;
													case 'Staff':
														echo "#S-".$_SESSION['admin_id']." ".$_SESSION['admin_email'];  
														break;
														case 'Volunteer':
															echo "#V-".$_SESSION['admin_id']." ".$_SESSION['admin_email']; 
															break;
															case 'Manager':
																echo "#M-".$_SESSION['admin_id']." ".$_SESSION['admin_email']; 
																break;}
