														...
														<div class="card-body">
															<div class="d-sm-flex mb-3">
																<div class="img-card mb-sm-0 mb-3">
																	...
																	<div
																		class="info d-flex align-items-center p-md-3 p-2 bg-primary">
																		<svg class="mr-3 d-sm-inline-block d-none" width="30"
																		...
																		<div>
																			...
																			<p class="fs-18 mb-0 text-black">
																				<?php echo $row['address'] ?><strong
																					class="d-block">CADGE 94107</strong>
																			</p>
																		</div>
																	</div>
																</div>
																<div class="col-sm-5">
																	<div class="map-bx">
																		...
																		<a href="javascript:void(0)"
																			class="btn btn-sm btn-primary p-1 fs-12">View in
																			Fullscreen</a>
