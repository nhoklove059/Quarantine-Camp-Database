							...
							<div class="card-body">
								...
								<div class="table-responsive">
									<table class="table table-striped table-responsive-md">
										...
										<tbody>
											<tr>
												<td><span class="text-nowrap"><?php echo $row_treatment["peopleName"]; ?></span></td>
												<td><span class="text-nowrap"><?php echo $row_treatment["fullName"]; ?></span></td>
												<?php
												...
												?>
												<td><?php echo $row_treatment["startDate"]; ?></td>
												<td><?php echo $row_treatment["endDate"]; ?></td>
											</tr>
										</tbody>
										<?php
											}
