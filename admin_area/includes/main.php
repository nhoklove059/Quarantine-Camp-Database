								...
								<a href="./app-profile.php" class="dropdown-item ai-icon">
									...
									<span class="ml-2">
										...
										switch ($_SESSION["admin_job"]) {
											case 'Doctor':
												echo "#D - " . $_SESSION['admin_id'] . " " . $_SESSION['username'];
												break;
											case 'Nurse':
												echo "#N - " . $_SESSION['admin_id'] . " " . $_SESSION['username'];
												break;
											case 'Staff':
												echo "#S - " . $_SESSION['admin_id'] . " " . $_SESSION['username'];
												break;
											case 'Volunteer':
												echo "#V - " . $_SESSION['admin_id'] . " " . $_SESSION['username'];
												break;
											case 'Manager':
												echo "#M - " . $_SESSION['admin_id'] . " " . $_SESSION['username'];
												break;
										}
