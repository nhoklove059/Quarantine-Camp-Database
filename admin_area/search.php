                                    ...
                                    <div class="panel-heading"><!-- panel-heading Starts -->
                                        ...
                                        <h3 class="panel-title"><!-- panel-title Starts -->
                                            ...
                                            <form action='search.php' method='get'>
                                                Key words<input type='text' value='<?php echo $txtname; ?>' name='txtName'
                                                    placeholder="enter keywords">
                                                Date from: <input type='date' value='<?php echo $txtdate_from; ?>'
                                                    name='txtDate_from' placeholder="yyyy-mm-dd">
                                                Date to: <input type='date' value='<?php echo $txtdate_to; ?>' name='txtDate_to'
                                                    placeholder="yyyy-mm-dd">
                                                <input type='submit' value='Search'>
                                            </form>

                                            <a href="http://localhost/B01%20(1)/admin_area/search.php?txtName=+&txtDate=+"><input
                                                    type='submit' value='All'></a>
                                                ...
                                                <tbody><!-- tbody Starts -->
                                                    ...
                                                    while ($row_orders = mysqli_fetch_array($run_orders)) {
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <?php echo $row_customer_order['delivery_date']; ?>
                                                            </td>
                                                            <td>$
                                                                <?php echo $due_amount; ?>
                                                            </td>
                                                            ...
                                                            switch ($order_status) {
                                                                ...
                                                                case 'pending': ?>
                                                                    <td>
                                                                        <?php
                                                                        ?><a href="update_status.php?order_delete=<?php echo $order_id; ?>">
                                                                            <?php echo $order_status = '<div style="color:red;">Pending</div>';
                                                                            ?>
                                                                    </td>
                                                                    <td>
                                                                ...
                                                                case 'processing': ?>
                                                                    <td>
                                                                        <?php
                                                                        ?><a href="update_status_complete.php?order_delete=<?php echo $order_id; ?>">
                                                                            <?php echo $order_status = '<div style="color:green;">Processing</div>';
                                                                            ?>
                                                                    </td>
                                                                    <td>
                                                                        <a href="order_delete.php?order_delete=<?php echo $order_id; ?>">
