				...
				<div class="form-head d-flex mb-sm-4 mb-3">
					...
					<div>
						<a href="javascript:void(0)" class="btn btn-primary mr-3" data-toggle="modal"
							data-target="#addOrderModal">+New Testing</a>
							...
							<div class="modal-body">
								<form action="add_test.php" method="get">
									...
									<div class="form-group">
										...
										<select class="d-block w-100 default-select" id="gender" name="testing_type"
											required="">
									...
									<div class="form-group">
										...
										<select class="d-block w-100 default-select" name="result" id="gender"
											required="">
											<option value="">Choose...</option>
						...
						<div class="table-responsive card-table">
							<table id="example5" class="display dataTablesCard table-responsive-xl">
								...
								if (!isset($_GET['people_id'])) {
									$sql = "SELECT * FROM `testing_information` WHERE `patientID` = " . $_GET['patientID'] . " AND `PCR_test_result` = 1";
								}
										...
										<tbody>
											...
											<img src="images/users/12.png" alt="" width="43">
												...
												<td><span class="text-nowrap">
														<?php echo $row['testTime']; ?>
													</span></td>
												<td><span class="text-nowrap">
														<?php echo $row['PCR_test_result']; ?>
													</span></td>
												<td><span class="text-dark">
														<?php echo $row['PCR_test_value']; ?>
													</span></td>
												<td><span class="text-dark">
														<?php echo $row['quick_test_result']; ?>
													</span></td>
												<td><span class="text-dark">
														<?php echo $row['quick_test_value']; ?>
													</span></td>
												<td><span class="text-dark">
														<?php echo $row['SPO2_percentage']; ?>
													</span></td>
												<td><span class="text-dark">
														<?php echo $row['Respiratory_rate']; ?> bpm
													</span></td>
												<td>
