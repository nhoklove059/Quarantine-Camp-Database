											...
											<div class="d-flex flex-wrap align-items-center px-4 bg-light">
												<div class="mr-auto d-flex align-items-center py-3">
													...
													<div>
														...
														<span class="fs-26 text-primary font-w600">20</span>
													</div>
												</div>
						...
						<div class="col-xl-12">
							<div class="card patient-activity">
								...
								<div class="card-footer text-center border-0">
									<a href="table-datatable-basic.php?status=all" class="btn-link">See More >></a>
								</div>
							</div>
						</div>
					</div>
